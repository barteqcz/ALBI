...
if [[ $cups_installation == "yes" ]]; then
    ...
    pacman -S cups cups-filters cups-pk-helper bluez-cups foomatic-db foomatic-db-engine foomatic-db-gutenprint-ppds foomatic-db-nonfree foomatic-db-nonfree-ppds foomatic-db-ppds ghostscript gutenprint nss-mdns --noconfirm >/dev/null 2>&1
