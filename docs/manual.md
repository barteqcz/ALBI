...
### Timezone
`timezone` - This is a definition of the timezone, that should be used in the system. The full list of available timezones is available in docs/timezones_list.
...
### Locales settings
`language` - Sets selected language systemwide. The full list of available languages is available in docs/languages_list.

`console_keyboard_layout` - This keyboard layout will be used systemwide as a console keyboard layout. But take into account, that it won't be used in graphical environment. Full list is available in docs/keymaps_list
